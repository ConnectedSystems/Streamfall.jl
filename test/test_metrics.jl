...
@testset "Kling-Gupta behavior" begin
...
@testset "Modified Kling-Gupta behavior" begin
...
@testset "Non-parametric Kling-Gupta behavior" begin
    @test Streamfall.npKGE(test_seq, test_seq) == 1.0
    @test Streamfall.npKGE([10.0, 10.0, 10.0], [10.0, 10.0, 10.0]) == 1.0
    @test Streamfall.npKGE([0.0, 0.0, 0.0], [10.0, 0.0, 0.0]) ≈ -1.386303510546059
