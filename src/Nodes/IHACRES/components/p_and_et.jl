...
"""
function calc_effective_rainfall(
    rainfall::Float64, cmd::Float64, d::Float64,
    d2::Float64; n::Float64=0.1
)::Float64
    scaled_d = d * d2
...
- Estimate of ET
"""
function calc_ET_from_E(e::F, evap::F, Mf::F, f::F, d::F)::F where {F<:Float64}
    param_g = f * d
    et = e * evap
...
"""
function calc_ET_from_T(e::F, T::F, Mf::F, f::F, d::F)::F where {F<:Float64}
